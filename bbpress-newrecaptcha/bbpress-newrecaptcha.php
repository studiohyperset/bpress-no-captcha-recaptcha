...
Text Domain: bbpress-newrecaptcha
*/
...
add_action('bbp_theme_before_reply_form_submit_wrapper', 'bbp_newrecaptcha_insert_form');
...
add_action('bbp_new_reply_pre_extras', 'bbp_newrecaptcha_verify_result');
